...
try:
    ...
    print(e)
    raise("Usage: python3 dds_cut.py record_dir start_timestamp(ns) end_timestamp(ns)")

if not os.path.exists(os.path.join(dir_path, "slice_record")):
	os.mkdir(os.path.join(dir_path, "slice_record"))
print(dir_path)
for path in os.listdir(dir_path):
	...
	f=open(dir_path+"/slice_record/"+os.path.basename(path),'wb')

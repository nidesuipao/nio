...
"""autogenerated by genpy from rospy_message_converter/FreeSpace.msg. Do not edit."""
import codecs
import sys
...
class FreeSpace(genpy.Message):
  _md5sum = "3c2e621a77562d48cae158daf83f6ca6"
  _type = "rospy_message_converter/FreeSpace"
...
"""
  __slots__ = ['FSP_Obs_ID','FSP_Lane_Assginment','FSP_Range','FSP_Azimuth_Angle','FSP_Classification_Type','FSP_Height','FSP_Elevation_Angle','FSP_Mobility_Status','FSP_Existence_Prob']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       FSP_Obs_ID,FSP_Lane_Assginment,FSP_Range,FSP_Azimuth_Angle,FSP_Classification_Type,FSP_Height,FSP_Elevation_Angle,FSP_Mobility_Status,FSP_Existence_Prob
    ...
    if args or kwds:
      ...
      if self.FSP_Range is None:
        self.FSP_Range = 0.
      if self.FSP_Azimuth_Angle is None:
        self.FSP_Azimuth_Angle = 0.
      if self.FSP_Classification_Type is None:
        self.FSP_Classification_Type = 0
      if self.FSP_Height is None:
        self.FSP_Height = 0.
      if self.FSP_Elevation_Angle is None:
        self.FSP_Elevation_Angle = 0.

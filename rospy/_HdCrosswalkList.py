...
"""autogenerated by genpy from rospy_message_converter/HdCrosswalkList.msg. Do not edit."""
import codecs
import sys
...
class HdCrosswalkList(genpy.Message):
  _md5sum = "d0c4c6036154ed13c45de5f7197bc8c3"
  _type = "rospy_message_converter/HdCrosswalkList"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """HdCrosswalk[] crosswalk_list
...
float64[] z
"""
  __slots__ = ['crosswalk_list']
  _slot_types = ['rospy_message_converter/HdCrosswalk[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HdCrosswalkList, self).__init__(*args, **kwds)

...
"""autogenerated by genpy from rospy_message_converter/FreeSpaceDetectionEuclidean.msg. Do not edit."""
import codecs
import sys
...
class FreeSpaceDetectionEuclidean(genpy.Message):
  _md5sum = "e06a9a56485c53c164d92398c60596ae"
  _type = "rospy_message_converter/FreeSpaceDetectionEuclidean"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint64 timestamp
FreeSpaceEuclidean[] freespace
int32 source
...
================================================================================
MSG: rospy_message_converter/FreeSpaceEuclidean
uint32 FSP_Obs_ID
...
"""
  ...
  _slot_types = ['uint64','rospy_message_converter/FreeSpaceEuclidean[]','int32','uint64','string','uint64','uint64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FreeSpaceDetectionEuclidean, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rospy_message_converter.msg.FreeSpaceEuclidean()
        _x = val1
        start = end
        end += 36

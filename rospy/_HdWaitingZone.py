...
"""autogenerated by genpy from rospy_message_converter/HdWaitingZone.msg. Do not edit."""
import codecs
import sys
...
class HdWaitingZone(genpy.Message):
  _md5sum = "52fbdc1eb575b3533625ae3717b5c7ca"
  _type = "rospy_message_converter/HdWaitingZone"
...
float64 z
"""
  __slots__ = ['id','surface','link_feature_points','lane_ids']
  _slot_types = ['uint64','rospy_message_converter/MapPolygon','rospy_message_converter/LinkFeaturePoint[]','uint64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,surface,link_feature_points,lane_ids
    ...
    """
    if args or kwds:
      super(HdWaitingZone, self).__init__(*args, **kwds)

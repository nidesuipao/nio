...
"""autogenerated by genpy from rospy_message_converter/ParObjMap.msg. Do not edit."""
import codecs
import sys
...
class ParObjMap(genpy.Message):
  _md5sum = "f3a463a2f3ca62aebcbc8ece649f3fa1"
  _type = "rospy_message_converter/ParObjMap"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """ParSingleObject[] objs
NodeInfo node_info
...
================================================================================
MSG: rospy_message_converter/ParSingleObject
int32 type
ParPoint[] points
...
uint32[] buffer
"""
  __slots__ = ['objs','node_info','publish_ptp_ts','publisher_id','counter','publish_ts']
  _slot_types = ['rospy_message_converter/ParSingleObject[]','rospy_message_converter/NodeInfo','uint64','string','uint64','uint64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       objs,node_info,publish_ptp_ts,publisher_id,counter,publish_ts
    ...
    """
    if args or kwds:
      super(ParObjMap, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rospy_message_converter.msg.ParSingleObject()
        start = end
        end += 4
        ...
        val1.points = []
        for i in range(0, length):
          val2 = rospy_message_converter.msg.ParPoint()
          _x = val2
          start = end
          end += 12

...
"""autogenerated by genpy from rospy_message_converter/AdasNavInfo.msg. Do not edit."""
import codecs
import sys
...
class AdasNavInfo(genpy.Message):
  _md5sum = "2d36270621aec2680383845ec29d9abe"
  _type = "rospy_message_converter/AdasNavInfo"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """NavHeartBeatInfo heart_beat_info
...
"""
  ...
  _slot_types = ['rospy_message_converter/NavHeartBeatInfo','rospy_message_converter/NavTurnInfo','rospy_message_converter/NavSpeedLimitInfo[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AdasNavInfo, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.heart_beat_info is None:
        self.heart_beat_info = rospy_message_converter.msg.NavHeartBeatInfo()
      if self.turn_info is None:
        self.turn_info = rospy_message_converter.msg.NavTurnInfo()

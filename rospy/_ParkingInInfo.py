...
"""autogenerated by genpy from rospy_message_converter/ParkingInInfo.msg. Do not edit."""
import codecs
import sys
...
class ParkingInInfo(genpy.Message):
  _md5sum = "e936d2710b2a3521763843ed41e58d21"
  _type = "rospy_message_converter/ParkingInInfo"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """ParkSlot[] slots
...
"""
  __slots__ = ['slots']
  _slot_types = ['rospy_message_converter/ParkSlot[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ParkingInInfo, self).__init__(*args, **kwds)

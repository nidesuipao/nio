...
"""autogenerated by genpy from rospy_message_converter/HdCrosswalk.msg. Do not edit."""
import codecs
import sys
...
class HdCrosswalk(genpy.Message):
  _md5sum = "d5f0f473dbbed93583340c2a23585bc9"
  _type = "rospy_message_converter/HdCrosswalk"
...
float64[] z
"""
  __slots__ = ['id','surface','lane_id']
  _slot_types = ['uint64','rospy_message_converter/MapPolygon','uint64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HdCrosswalk, self).__init__(*args, **kwds)

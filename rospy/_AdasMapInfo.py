...
"""autogenerated by genpy from rospy_message_converter/AdasMapInfo.msg. Do not edit."""
import codecs
import sys
...
class AdasMapInfo(genpy.Message):
  _md5sum = "117c9a1437de5d7fb38b2a31c1867cb9"
  _type = "rospy_message_converter/AdasMapInfo"
...
"""
  __slots__ = ['is_adasmap_valid','m_adasmap_is_highway','adas_meta','segment','profile_point','stub','traffic_sign','lane_connection','traffic_event','traffic_flow','main_path_shape','sub_path_shapes','main_path_curvatures','is_position_good','is_curr_horizon_empty','is_pos_outdated','sub_path_segments']
  _slot_types = ['bool','uint32','rospy_message_converter/AdasMapMeta','rospy_message_converter/AdasMapSegment[]','rospy_message_converter/AdasMapProfilePoint[]','rospy_message_converter/AdasMapStub[]','rospy_message_converter/AdasMapTrafficSign[]','rospy_message_converter/AdasMapLaneConnection[]','rospy_message_converter/AdasMapTrafficEvent[]','rospy_message_converter/AdasMapTrafficFlow[]','rospy_message_converter/AdasMapPathShape','rospy_message_converter/AdasMapPathShape[]','rospy_message_converter/AdasMapCurvature[]','bool','bool','bool','rospy_message_converter/AdasMapSubPathSegments[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       is_adasmap_valid,m_adasmap_is_highway,adas_meta,segment,profile_point,stub,traffic_sign,lane_connection,traffic_event,traffic_flow,main_path_shape,sub_path_shapes,main_path_curvatures,is_position_good,is_curr_horizon_empty,is_pos_outdated,sub_path_segments
    ...
    """
    if args or kwds:
      super(AdasMapInfo, self).__init__(*args, **kwds)
      ...
      if self.adas_meta is None:
        self.adas_meta = rospy_message_converter.msg.AdasMapMeta()
      ...
      if self.traffic_flow is None:
        self.traffic_flow = []
      if self.main_path_shape is None:
        self.main_path_shape = rospy_message_converter.msg.AdasMapPathShape()
      if self.sub_path_shapes is None:
        self.sub_path_shapes = []
      if self.main_path_curvatures is None:
        self.main_path_curvatures = []
      if self.is_position_good is None:
        self.is_position_good = False
      if self.is_curr_horizon_empty is None:
        self.is_curr_horizon_empty = False
      if self.is_pos_outdated is None:
        self.is_pos_outdated = False
      if self.sub_path_segments is None:
        self.sub_path_segments = []
    else:
      self.is_adasmap_valid = False
      self.m_adasmap_is_highway = 0
      self.adas_meta = rospy_message_converter.msg.AdasMapMeta()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B4I().pack(_x.is_adasmap_valid, _x.m_adasmap_is_highway, _x.adas_meta.country_code, _x.adas_meta.speed_unit, _x.adas_meta.provider))
      ...
      length = len(self.traffic_flow)
      buff.write(_struct_I.pack(length))
      for val1 in self.traffic_flow:
        _x = val1
        buff.write(_get_struct_3QiQ().pack(_x.offset, _x.index, _x.path_idx, _x.traffic_flow_status, _x.reliability))
      _x = self
      buff.write(_get_struct_QB().pack(_x.main_path_shape.path_idx, _x.main_path_shape.is_main_path))
      length = len(self.main_path_shape.shape_points_raw)
      buff.write(_struct_I.pack(length))
      for val1 in self.main_path_shape.shape_points_raw:
        _x = val1
        buff.write(_get_struct_3QB().pack(_x.offset, _x.index, _x.path_idx, _x.is_control_point))
        _v2 = val1.shape_point
        _x = _v2
        buff.write(_get_struct_4d().pack(_x.longitude, _x.latitude, _x.utm_x, _x.utm_y))
      length = len(self.main_path_shape.shape_points_inter)
      buff.write(_struct_I.pack(length))
      for val1 in self.main_path_shape.shape_points_inter:
        _x = val1
        buff.write(_get_struct_3QB().pack(_x.offset, _x.index, _x.path_idx, _x.is_control_point))
        _v3 = val1.shape_point
        _x = _v3
        buff.write(_get_struct_4d().pack(_x.longitude, _x.latitude, _x.utm_x, _x.utm_y))
      length = len(self.sub_path_shapes)
      buff.write(_struct_I.pack(length))
      for val1 in self.sub_path_shapes:
        _x = val1
        ...
        for val2 in val1.shape_points_inter:
          ...
          _x = _v5
          buff.write(_get_struct_4d().pack(_x.longitude, _x.latitude, _x.utm_x, _x.utm_y))
      length = len(self.main_path_curvatures)
      buff.write(_struct_I.pack(length))
      for val1 in self.main_path_curvatures:
        _x = val1
        buff.write(_get_struct_3QdB().pack(_x.offset, _x.index, _x.path_idx, _x.curvature, _x.is_control_point))
      _x = self
      buff.write(_get_struct_3B().pack(_x.is_position_good, _x.is_curr_horizon_empty, _x.is_pos_outdated))
      length = len(self.sub_path_segments)
      buff.write(_struct_I.pack(length))
      for val1 in self.sub_path_segments:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if self.main_path_shape is None:
        self.main_path_shape = rospy_message_converter.msg.AdasMapPathShape()
      if self.sub_path_shapes is None:
        self.sub_path_shapes = None
      if self.main_path_curvatures is None:
        self.main_path_curvatures = None
      if self.sub_path_segments is None:
        self.sub_path_segments = None
      end = 0
      _x = self
      start = end
      end += 17
      (_x.is_adasmap_valid, _x.m_adasmap_is_highway, _x.adas_meta.country_code, _x.adas_meta.speed_unit, _x.adas_meta.provider,) = _get_struct_B4I().unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.traffic_flow.append(val1)
      _x = self
      start = end
      end += 9
      (_x.main_path_shape.path_idx, _x.main_path_shape.is_main_path,) = _get_struct_QB().unpack(str[start:end])
      self.main_path_shape.is_main_path = bool(self.main_path_shape.is_main_path)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.main_path_shape.shape_points_raw = []
      for i in range(0, length):
        ...
        (_x.longitude, _x.latitude, _x.utm_x, _x.utm_y,) = _get_struct_4d().unpack(str[start:end])
        self.main_path_shape.shape_points_raw.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.main_path_shape.shape_points_inter = []
      for i in range(0, length):
        val1 = rospy_message_converter.msg.AdasMapShapePoint()
        _x = val1
        start = end
        ...
        (_x.longitude, _x.latitude, _x.utm_x, _x.utm_y,) = _get_struct_4d().unpack(str[start:end])
        self.main_path_shape.shape_points_inter.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.sub_path_shapes = []
      for i in range(0, length):
        ...
        self.sub_path_shapes.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.main_path_curvatures = []
      for i in range(0, length):
        ...
        val1.is_control_point = bool(val1.is_control_point)
        self.main_path_curvatures.append(val1)
      _x = self
      start = end
      end += 3
      (_x.is_position_good, _x.is_curr_horizon_empty, _x.is_pos_outdated,) = _get_struct_3B().unpack(str[start:end])
      self.is_position_good = bool(self.is_position_good)
      self.is_curr_horizon_empty = bool(self.is_curr_horizon_empty)
      self.is_pos_outdated = bool(self.is_pos_outdated)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.sub_path_segments = []
      for i in range(0, length):
        ...
        self.sub_path_segments.append(val1)
      return self

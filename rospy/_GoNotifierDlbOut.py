...
"""autogenerated by genpy from rospy_message_converter/GoNotifierDlbOut.msg. Do not edit."""
import codecs
import sys
...
class GoNotifierDlbOut(genpy.Message):
  _md5sum = "ff6dd2e83f2bd6d9cec2d3cf7c227538"
  _type = "rospy_message_converter/GoNotifierDlbOut"
...
"""
  __slots__ = ['cipv_index','cipv_valid','cipv_lon_pos','lead_obj_last_index','lead_obj_last_valid','lead_obj_last_lon_pos','np_sts','dms_phylink_fim','dms_sts','dms_result_valid','dms_result_conf','dms_dstr_lvl','obs_dist_fl','obs_dist_fm','obs_dist_fr','ego_standstill','ego_standstill_age','req_send_flag','no_lead_obj_age','np_cond','ego_cond','drv_distracted','lead_obj_exist','lead_obj_leave_age','lead_obj_dis_age','lead_obj_cond','uss_fail','obs_cond','sys_fail','smstate','gn_request','gn_request_age']
  _slot_types = ['uint32','uint32','float64','uint32','uint32','float64','uint32','bool','uint32','bool','float64','uint32','uint32','uint32','uint32','bool','float64','bool','float64','bool','bool','bool','bool','float64','float64','bool','bool','bool','bool','uint32','uint32','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoNotifierDlbOut, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2Id2IdIBIBd4IBdBd4B2d4B2Id().pack(_x.cipv_index, _x.cipv_valid, _x.cipv_lon_pos, _x.lead_obj_last_index, _x.lead_obj_last_valid, _x.lead_obj_last_lon_pos, _x.np_sts, _x.dms_phylink_fim, _x.dms_sts, _x.dms_result_valid, _x.dms_result_conf, _x.dms_dstr_lvl, _x.obs_dist_fl, _x.obs_dist_fm, _x.obs_dist_fr, _x.ego_standstill, _x.ego_standstill_age, _x.req_send_flag, _x.no_lead_obj_age, _x.np_cond, _x.ego_cond, _x.drv_distracted, _x.lead_obj_exist, _x.lead_obj_leave_age, _x.lead_obj_dis_age, _x.lead_obj_cond, _x.uss_fail, _x.obs_cond, _x.sys_fail, _x.smstate, _x.gn_request, _x.gn_request_age))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cipv_index, _x.cipv_valid, _x.cipv_lon_pos, _x.lead_obj_last_index, _x.lead_obj_last_valid, _x.lead_obj_last_lon_pos, _x.np_sts, _x.dms_phylink_fim, _x.dms_sts, _x.dms_result_valid, _x.dms_result_conf, _x.dms_dstr_lvl, _x.obs_dist_fl, _x.obs_dist_fm, _x.obs_dist_fr, _x.ego_standstill, _x.ego_standstill_age, _x.req_send_flag, _x.no_lead_obj_age, _x.np_cond, _x.ego_cond, _x.drv_distracted, _x.lead_obj_exist, _x.lead_obj_leave_age, _x.lead_obj_dis_age, _x.lead_obj_cond, _x.uss_fail, _x.obs_cond, _x.sys_fail, _x.smstate, _x.gn_request, _x.gn_request_age,) = _get_struct_2Id2IdIBIBd4IBdBd4B2d4B2Id().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2Id2IdIBIBd4IBdBd4B2d4B2Id = None
def _get_struct_2Id2IdIBIBd4IBdBd4B2d4B2Id():
    global _struct_2Id2IdIBIBd4IBdBd4B2d4B2Id
    if _struct_2Id2IdIBIBd4IBdBd4B2d4B2Id is None:
        _struct_2Id2IdIBIBd4IBdBd4B2d4B2Id = struct.Struct("<2Id2IdIBIBd4IBdBd4B2d4B2Id")
    return _struct_2Id2IdIBIBd4IBdBd4B2d4B2Id

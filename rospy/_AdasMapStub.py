...
"""autogenerated by genpy from rospy_message_converter/AdasMapStub.msg. Do not edit."""
import codecs
import sys
...
class AdasMapStub(genpy.Message):
  _md5sum = "2c55a6e1ae8afe1e5da0ad9612f05aa3"
  _type = "rospy_message_converter/AdasMapStub"
...
"""
  __slots__ = ['offset','index','path_idx','sub_path_idx','relative_probability','road_class','is_part_of_calculated_route','is_complex_intersection','form_of_way','turn_angle','is_last_stub','right_of_way','num_of_lanes_opp_dir','num_of_lanes_drv_dir']
  _slot_types = ['uint64','uint64','uint64','uint32','uint32','int32','bool','bool','uint32','uint32','bool','uint32','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       offset,index,path_idx,sub_path_idx,relative_probability,road_class,is_part_of_calculated_route,is_complex_intersection,form_of_way,turn_angle,is_last_stub,right_of_way,num_of_lanes_opp_dir,num_of_lanes_drv_dir
    ...
    """
    if args or kwds:
      super(AdasMapStub, self).__init__(*args, **kwds)

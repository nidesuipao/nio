...
"""autogenerated by genpy from rospy_message_converter/AdasMapLaneConnection.msg. Do not edit."""
import codecs
import sys
...
class AdasMapLaneConnection(genpy.Message):
  _md5sum = "4afb9212eb3fcbbdc0831c3d533033b5"
  _type = "rospy_message_converter/AdasMapLaneConnection"
...
uint32 yield_flag
"""
  __slots__ = ['offset','index','path_idx','lane_num','first_predecessor_lane','last_predecessor_lane','priority_predecessor_lane','arrow_marking','lane_type','line_marking','yield_flag']
  _slot_types = ['uint64','uint64','uint64','uint32','uint32','uint32','uint32','uint32','uint32','uint32','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       offset,index,path_idx,lane_num,first_predecessor_lane,last_predecessor_lane,priority_predecessor_lane,arrow_marking,lane_type,line_marking,yield_flag
    ...
    """
    if args or kwds:
      super(AdasMapLaneConnection, self).__init__(*args, **kwds)

...
"""autogenerated by genpy from rospy_message_converter/FySdowTrackedObj.msg. Do not edit."""
import codecs
import sys
...
class FySdowTrackedObj(genpy.Message):
  _md5sum = "6696fa83832ac091382446b01a946810"
  _type = "rospy_message_converter/FySdowTrackedObj"
...
uint32[] reserved
"""
  __slots__ = ['id','age','longDist','latDist','longVel','latVel','longAccel','latAccel','heading','curvature','existConfidence','length','width','motionStatus','detectionSensor','type','refPoint','trackerStatus','visionDetectionSensor','longDist_sl','latDist_sl','longVel_sl','latVel_sl','longAccel_sl','latAccel_sl','is_valid_by_spd','is_in_range_long','is_any_pt_in_rect_right','is_any_pt_in_rect_left','is_frntmid_pt_in_range_right','is_frntmid_pt_in_range_left','is_in_region_right_far','is_in_region_left_far','is_in_region_right_near','is_in_region_left_near','is_valid_threat_right','is_valid_threat_left','is_tracked','ta_info_left','ta_info_right','is_updated','threat_time_left','threat_time_right','life_time','ttc','meet_ttc_thresh','is_following_lane','dist_to_collide_position','is_dist_to_collide_position_big','suppress_warn_by_brake_dist','reserved']
  _slot_types = ['uint32','uint32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','int32','uint32','int32','uint32','uint32','uint32','float32','float32','float32','float32','float32','float32','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','bool','float32','float32','bool','uint32','uint32','uint32','float32','bool','bool','float32','bool','bool','uint32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FySdowTrackedObj, self).__init__(*args, **kwds)
      ...
      if self.is_in_region_right_far is None:
        self.is_in_region_right_far = False
      if self.is_in_region_left_far is None:
        self.is_in_region_left_far = False
      if self.is_in_region_right_near is None:
        self.is_in_region_right_near = False
      if self.is_in_region_left_near is None:
        self.is_in_region_left_near = False
      ...
      if self.ttc is None:
        self.ttc = 0.
      if self.meet_ttc_thresh is None:
        self.meet_ttc_thresh = False
      if self.is_following_lane is None:
        self.is_following_lane = False
      if self.dist_to_collide_position is None:
        self.dist_to_collide_position = 0.
      if self.is_dist_to_collide_position_big is None:
        self.is_dist_to_collide_position_big = False
      if self.suppress_warn_by_brake_dist is None:
        self.suppress_warn_by_brake_dist = False
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.is_in_region_right_far = bool(self.is_in_region_right_far)
      self.is_in_region_left_far = bool(self.is_in_region_left_far)
      self.is_in_region_right_near = bool(self.is_in_region_right_near)
      self.is_in_region_left_near = bool(self.is_in_region_left_near)
      ...
      self.meet_ttc_thresh = bool(self.meet_ttc_thresh)
      self.is_following_lane = bool(self.is_following_lane)
      self.is_dist_to_collide_position_big = bool(self.is_dist_to_collide_position_big)
      self.suppress_warn_by_brake_dist = bool(self.suppress_warn_by_brake_dist)
      start = end
      end += 4
